...
namespace SFA.DAS.Forecasting.Jobs.Application.UnitTests.Handlers
{
    ...
    public class WhenHandlingApprenticeshipCompletedEvent
    {
        ...
        {
            //Arrange
            var fixture = new ApprenticeshipCompletedEventTestsFixture().SetApprenticeshipId();
        ...
        {
            //Arrange            
            var fixture = new ApprenticeshipCompletedEventTestsFixture().SetApprenticeshipId().SetException();
        ...
        {
            //Arrange            
            var fixture = new ApprenticeshipCompletedEventTestsFixture().SetApprenticeshipId().SetCommitmentsApiModelException();
    ...
    public class ApprenticeshipCompletedEventTestsFixture
    {
        ...
        public ApprenticeshipCompletedEventTestsFixture()
        {
            ...
            Sut = new ApprenticeshipCompletedEventHandler(Db, MockCommitmentsApiClient.Object, mapper, MockLogger.Object);
            Db.SaveChanges();
        }

        public ApprenticeshipCompletedEventTestsFixture SetApprenticeshipId()
        {
